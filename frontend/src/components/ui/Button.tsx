...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', loading, children, disabled, asChild, ...props }, ref) => {
    ...
    const variants = {
      primary: 'bg-primary-700 text-white hover:bg-primary-600 focus:ring-primary-500 shadow-soft hover:shadow-medium',
      ...
      danger: 'bg-error text-white hover:bg-red-700 focus:ring-red-500 shadow-soft hover:shadow-medium'
    }
